...
function QuickFormsSection() {
  return (
    <div className="mt-10 pt-8 border-t border-border">
      <div className="mb-4">
        <h2 className="text-sm font-semibold text-foreground">טפסים מהירים</h2>
        <p className="text-xs text-muted-foreground mt-0.5">מילוי טופס בודד ללא יצירת טיול — מתאים לטיולים קצרים</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <a href="/quick/bus-check"
          className="flex items-start gap-3 p-4 bg-white border border-border rounded-[var(--radius)] shadow-[var(--shadow-card)] hover:shadow-md transition-shadow group">
          <div className="w-9 h-9 rounded-lg bg-[#1b4332]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-foreground group-hover:text-primary transition-colors">בדיקת אוטובוס</p>
            <p className="text-xs text-muted-foreground mt-0.5">נספח ט"ו — לפני היציאה לטיול</p>
          </div>
          <svg className="w-4 h-4 text-muted-foreground mt-1 flex-shrink-0 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/quick/gimel"
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-foreground group-hover:text-primary transition-colors">כתב מינוי לאחראי/ת טיול</p>
            <p className="text-xs text-muted-foreground mt-0.5">נספח ג׳ — בחתימת מנהל/ת ביה"ס</p>
          </div>
          <svg className="w-4 h-4 text-muted-foreground mt-1 flex-shrink-0 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
